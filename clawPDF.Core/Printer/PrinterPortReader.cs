...
namespace clawSoft.clawPDF.Core.Printer
{
    ...
    {
        private const string DefaultTempFolderName = "infosecPDF";
        private const string RegistryBaseKey = @"SYSTEM\CurrentControlSet\Control\Print\Monitors\infosecmon\infosecmon:\";
